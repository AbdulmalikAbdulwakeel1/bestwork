            ...
            <div class="max-content similar__form form__padding">
                ...
                <form method="POST" action="{{ route('register') }}" class="d-flex flex-column gap-3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="position-relative">
                            <input type="text" name="name" id="sname" value="{{ old('name') }}" placeholder="Your Name" required autofocus autocomplete="name">
                            <i class="fa-light fa-user icon"></i>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="position-relative">
                            <input type="email" name="email" id="signemail" value="{{ old('email') }}" placeholder="Enter your email" required autocomplete="username">
                    ...
                    <div class="form-group">
                        ...
                        <div class="position-relative">
                            <input type="password" name="password" id="spassword" placeholder="Enter your password" required autocomplete="new-password">
                            <i class="fa-light fa-lock icon"></i>
                        </div>
                    </div>
            ...
            <div class="max-content similar__form form__padding">
                ...
                <form method="POST" action="{{ route('password.email') }}" class="d-flex flex-column gap-3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="position-relative">
                            <input type="email" name="email" id="fmail" value="{{ old('email') }}" placeholder="Enter your email" required autofocus>
                            <i class="fa-sharp fa-light fa-envelope icon"></i>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    registerTabs.forEach(tab => {
        tab.addEventListener('click', function() {
            ...
            this.classList.add('active');
            registerUserType.value = this.getAttribute('data-type');
        });
    });
});
</script>